...
The serial port verification script (`check_ports.py`) and the GPS parsing and heading computation module (`gps_reader.py`) are provided in Folder - Gimbal Control Software Listings  for reference.
